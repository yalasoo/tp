        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), new Class("K1A"),
                    new Birthday("25-06-2020"), EMPTY_NOTE, getTagSet("student"), null,
                    new Favourite(false)),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), new Class("K1C"),
                    new Birthday("15-01-2020"), EMPTY_NOTE, getTagSet("student"), null,
                    new Favourite(false)),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Class("K2A"),
                    new Birthday("08-04-1984"), EMPTY_NOTE, getTagSet("colleague"), null,
                    new Favourite(false)),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), new Class("K2B"),
                    new Birthday("12-12-2019"), EMPTY_NOTE, getTagSet("student"), null,
                    new Favourite(false)),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new Address("Blk 45 Aljunied Street 85, #11-31"), new Class("K2C"),
                    new Birthday("20-09-1988"), EMPTY_NOTE, getTagSet("colleague"), null,
                    new Favourite(false))
        };
    }
