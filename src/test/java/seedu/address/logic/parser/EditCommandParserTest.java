...
public class EditCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified - should parse successfully but fail during execution
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + TAG_DESC_STUDENT + TAG_DESC_COLLEAGUE + TAG_EMPTY, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_DESC_STUDENT + TAG_EMPTY + TAG_DESC_COLLEAGUE, Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + TAG_DESC_STUDENT + TAG_DESC_COLLEAGUE, Tag.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_COLLEAGUE
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + CLASS_DESC_AMY + TAG_DESC_STUDENT;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withClass(VALID_CLASS_AMY).withTags(VALID_TAG_COLLEAGUE, VALID_TAG_STUDENT).build();
